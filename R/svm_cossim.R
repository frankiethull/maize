...
#' @description cossim kernel for support vector machines
...
#' @export
translate.svm_cossim <- function(x, engine = x$engine, ...) {
...
#' @export
check_args.svm_cossim <- function(object, call = rlang::caller_env()) {
  invisible(object)
}
