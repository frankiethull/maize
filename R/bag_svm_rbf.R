...
#' @param engine ebmc's ub which uses e1701's svm
#' @param num_learners how many weak learners should be ensembled via bagging
...
#' @export
translate.bag_svm_rbf <- function(x, engine = x$engine, ...) {
...
#' @export
check_args.bag_svm_rbf <- function(object, call = rlang::caller_env()) {
  invisible(object)
}
