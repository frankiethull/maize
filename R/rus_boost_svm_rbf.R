...
#' @param engine ebmc's rus which uses e1701's svm
...
#' @method update rus_boost_svm_rbf
#' @rdname parsnip_update
#' @export
update.rus_boost_svm_rbf <-
  function(object,
           parameters = NULL,
           num_learners = NULL, imb_ratio = NULL,
           fresh = FALSE,
...
#' @export
translate.rus_boost_svm_rbf <- function(x, engine = x$engine, ...) {
...
#' @export
check_args.rus_boost_svm_rbf <- function(object, call = rlang::caller_env()) {
  invisible(object)
}
