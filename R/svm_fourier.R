...
#' @description fourier kernel for support vector machines
...
#' @param sigma a sigma parameter for fourier kernels
#' @export
...
#' @export
translate.svm_fourier <- function(x, engine = x$engine, ...) {
...
#' @export
check_args.svm_fourier <- function(object, call = rlang::caller_env()) {
  invisible(object)
}
