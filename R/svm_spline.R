...
#' @description spline kernel for support vector machines
...
#' @export
translate.svm_spline <- function(x, engine = x$engine, ...) {
...
#' @export
check_args.svm_spline <- function(object, call = rlang::caller_env()) {
  invisible(object)
}
