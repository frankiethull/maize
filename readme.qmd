...
bind will require additional handlers for input since the dot expects list input instead of formula + dataframe. . .

bound with x + y method, minimal wrapper is called "ksvm_stringdot".. this is the underlying fcn now mapped to the svm_string_data set_fit call. 
```{r}
