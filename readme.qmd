...
{parnsip} has three kernels available: linear, radial basis function, & polynomial. {maize} binds five more {kernlab} kernels: laplace, bessel, anova rbf, spline, & hyperbolic tangent. **Additionally, {maize} has a few experimental kernels added in the most recent update: cauchy and cossim. The goal is to add many more kernels compatible with kernlab and parsnip.**    
