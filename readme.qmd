...
{parnsip} has three kernels available: linear, radial basis function, & polynomial. {maize} binds five more {kernlab} kernels: laplace, bessel, anova rbf, spline, & hyperbolic tangent. **{maize} has additional experimental kernels as well: cauchy, cosine similarity, tanimoto, sorensen, t-student, fourier, and wavelet. Feel free to pull request more novel kernels.**    
